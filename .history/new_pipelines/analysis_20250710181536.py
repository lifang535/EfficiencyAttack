...
def attack(attack_path=None):
    ...
    for rank_file in tqdm(files, desc="Processing JSON files"):
        ...
        current_file_cls_loss1 = [] 
        current_file_distance_loss1 = []
        current_file_iou_loss1 = []
        ...
        for i in range(num_iterations):
            ...
            current_file_cls_loss1.append(iter_data.get("cls_loss1", 0))
            current_file_distance_loss1.append(iter_data.get("distance_loss1", 0))
            current_file_iou_loss1.append(iter_data.get("iou_loss1", 0))
        ...
        all_files_cls_loss1.append(current_file_cls_loss1)
        all_files_distance_loss1.append(current_file_distance_loss1)
        all_files_iou_loss1.append(current_file_iou_loss1)
    ...
    all_files_distance_loss1_np = np.array(all_files_distance_loss1)
    all_files_cls_loss1_np = np.array(all_files_cls_loss1)
    all_files_iou_loss1_np = np.array(all_files_iou_loss1)
    ...
    mean_cls_loss1_per_iter = np.mean(all_files_cls_loss1_np, axis=0)
    mean_distance_loss1_per_iter = np.mean(all_files_distance_loss1_np, axis=0)
    mean_iou_loss1_per_iter = np.mean(all_files_iou_loss1_np, axis=0)
    ...
    ax1.plot(iterations, mean_cls_loss1_per_iter, label='Layer 1 Classification Loss', linestyle=':', color='blue')
    # ax1.plot(iterations, mean_distance_loss1_per_iter, label='Layer 1 Distance Loss', linestyle='-.', color='orange')
    ax1.plot(iterations, mean_iou_loss1_per_iter, label='Layer 1 IoU Loss', linestyle=':', color='purple')
