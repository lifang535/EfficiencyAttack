        ...
        for i in range(args.num_it):
            ...
            if args.use_patch:
                if args.patch_placement == "center":
                    h, w = img_tensor.shape[2:].to(img_tensor.device)
            ...
            distance_loss1 = calculate_distance_loss(res1[0], [sw, sh, sw+ pw, sh + ph])
            iou_loss1 = calculate_iou_loss(res1[0], [sw, sh, sw+ pw, sh + ph])
