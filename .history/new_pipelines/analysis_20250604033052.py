...
def clean():
    clean_path = "./saved/clean/object_detection"
    ...
    for json_file in json_files:
        file_path = os.path.join(clean_path, json_file)
        with open(file_path, 'r') as f:
            data = json.load(f)
            total_layer_1_num_detections += data["layer_1_num_detections"] 
            total_layer_2_num_detections += data["layer_2_num_detections"]
