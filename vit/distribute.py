...
if __name__ == "__main__":
    ...
    parser.add_argument("--val_size", type=int, choices=range(1, 4952), default=4952, 
    ...
    if args.algo_name == "phantom":
        ...
        # Save final results
        results_file = os.path.join(save_dir, 'final_results.json')
    ...
    if args.algo_name == "ada":
        timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
        save_dir = os.path.join('results', f'ada_attack_{timestamp}', f"{args.target_cls_idx}")
