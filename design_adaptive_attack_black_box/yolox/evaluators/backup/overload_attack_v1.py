    ...
    def evaluate(
        ...
        def process_img(imgs, path):
            ...
            for iter in tqdm(range(epochs)):
                ...
                yolo_outputs = yolo_model(input_imgs)[0]
                ...
                print(outputs)
                print(f"========== yolo_outputs: {yolo_outputs.shape} ==========")
                print(yolo_outputs)
                ...
                # print(f"========== process_yolo_inputs: {process_yolo_inputs.size} ==========")
                # process_yolo_outputs = yolo_image_processor.post_process_object_detection(outputs, threshold=0.9, target_sizes=torch.tensor([process_yolo_inputs[0].shape[::-1] for _ in range(1)]))
                
                print(f"========== process_outputs: {process_outputs.shape} ==========")
                print(process_outputs)
                # print(f"========== process_yolo_outputs: {process_yolo_outputs.shape} ==========")
