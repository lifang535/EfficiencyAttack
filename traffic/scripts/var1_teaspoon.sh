...
# python pipe_var1.py --model_id 0 --algorithm teaspoon --target_idx 23
# python pipe_var1.py --model_id 1 --algorithm teaspoon --target_idx 23
# python pipe_var1.py --model_id 2 --algorithm teaspoon --target_idx 23

# python pipe_var1.py --model_id 0 --algorithm teaspoon --target_idx 68
# python pipe_var1.py --model_id 1 --algorithm teaspoon --target_idx 68
# python pipe_var1.py --model_id 2 --algorithm teaspoon --target_idx 68
