...
class TeaSpoon(BaseAttack):
    ...
    def update_bx(self, it_count):
        ...
        total_loss = cls_loss + area_loss + norm_loss
        # clear grad
        ...
        self.area_loss_cpu = area_loss.clone().detach().cpu().item()
        self.norm_loss_cpu = norm_loss.clone().detach().cpu().item()
        self.cls_loss_cpu = cls_loss.clone().detach().cpu().item()
        return self.bx
    ...
    def logger(self, it):
        ...
        tmp_dict = {
            ...
            "area loss": self.area_loss_cpu,
            "norm loss": self.norm_loss_cpu,
            "cls loss": self.cls_loss_cpu
        }
